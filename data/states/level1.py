# Lines 2-18 are imports from libraries and files from the same folder in order for the code to be functional. 
...
# A Class is made to keep relating things together and organized.
class Level1(tools._State):
    # This function is a reseved method in python classes. This method is called when an object is created from a class and it allows the class to initialize the attributes of the class.
    def __init__(self):
        tools._State.__init__(self)
    # Function that is called after there is a State object created.
    ...
    # This function sets up the backgroung image of the game and its main menu.
    ...
    # This function makes the ground collideable by using invisible rects so any sprite can walk on it.
    ...
    # Function that creates the "pipes" in level 1 for the player to be able to jump on. The "pipes" are actually rects that are collideable and are added to the sprite group.
    ...
    # This function creates the stairway looking steps that Mario can step on because they are collideable.
    ...
    # Creates instances of interactive bricks including coin and powerup function.
    ...
    # This function creates boxes that contain coins in it that comes out when the player collides with it.
    ...
    # This function creates the flag pole that mario slides down at the end of the level.
    ...
    # This function creates the enemy sprites in the game such as the Goomba and the koopa and stores them in a list of lists.
    ...
    # Positions Mario at the start of the level
    def setup_mario(self):
        self.mario = mario.Mario()
        self.mario.rect.x = self.viewport.x + 110
        self.mario.rect.bottom = c.GROUND_HEIGHT

    # Creates and positions checkpoints that trigger enemy generation when collided with.
    ...
    # A collection of sprites created before their usage.
    ...
    # Updates the state of everything in the level
    ...
    # Updates Mario's state instead of the level state if its state is frozen.
    ...
    # Adjusts the state of mario's character depending what object he collides with.
    ...
    # When mario goes through the process of changing, then the level will freeze. 
    ...
    # Updates all visible sprites in their respective locations.
    ...
    # Manages check point properties such as collision, deletion, and generation.
    ...
    # Generates points when Mario collides with the flag pole.
